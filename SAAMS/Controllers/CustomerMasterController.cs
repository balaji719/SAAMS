    ...
    public class CustomerMasterController : Controller
    {
        ...
        public ActionResult WriteExcel()
        {
            ...
            try
            {
                ...
                string startPath = Server.MapPath("~/Downloads/CustomerDetails/");
                ...
                filetodownload = "Customer Report " + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".xlsx";
                ...
                Sqlcomrep.CommandText = "CustomerMList_get";
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    wb.SaveAs(System.Web.HttpContext.Current.Server.MapPath("~/Downloads/CustomerDetails/" + filetodownload));
                }
        ...
        public ActionResult Download(string file)
        {
            ...
            string fullPath = Path.Combine(Server.MapPath("~/Downloads/CustomerDetails/"), file);
        ...
        [HttpPost]
        public ActionResult CustomerMasterPdf()
        {
            string FileName = Path.Combine(Server.MapPath("~/Downloads/CustomerDetails/"));
            string filetodownload = "Customer Report " + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf";
            ...
            PdfPCell cell0;
            cell0 = new PdfPCell(new Phrase("CUSTOMER MASTER", F));
            ...
            cell = new PdfPCell(new Phrase("STATE", H));
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 2;
            ...
            cell = new PdfPCell(new Phrase("EMAILID", H));
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 2;
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                cell = new PdfPCell(new Phrase(dt.Rows[i].Field<string>("CustomerMobile").ToString(), I));
                cell.Colspan = 2;
                cell.PaddingBottom = 5;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                ...
                cell = new PdfPCell(new Phrase(dt.Rows[i].Field<string>("CustEmail").ToString(), I));
                cell.Colspan = 2;
                cell.PaddingBottom = 5;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
