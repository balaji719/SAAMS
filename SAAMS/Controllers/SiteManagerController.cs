...
namespace SAAMS.Controllers
{
    ...
    public class SiteManagerController : Controller
    {
        ...
        {
            List<SiteMList_get_Result> SiteList = new List<SiteMList_get_Result>();
            using (SecurityDBEntities entity = new SecurityDBEntities())
            {
                SiteList = entity.SiteMList_get(Convert.ToInt32(Session["ProfileId"]), Convert.ToInt32(Session["UserId"])).ToList();
            }
        ...
        public ActionResult Download(string file)
        {
            ...
            string fullPath = Path.Combine(Server.MapPath("~/Downloads/SiteDetails/"), file);
        ...
        [HttpPost]
        public ActionResult SiteManagerPdf()
        {
            string FileName = Path.Combine(Server.MapPath("~/Downloads/SiteDetails/"));
            string filetodownload = "Site Report " + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf";
            ...
            PdfPCell cell0;
            cell0 = new PdfPCell(new Phrase("SITE MANAGER", F));
            ...
            cell = new PdfPCell(new Phrase("CLIENT", H));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 2;
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            ...
            cell = new PdfPCell(new Phrase("CUSTOMER", H));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 2;
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            ...
            cell = new PdfPCell(new Phrase("BRANCH ", H));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 2;
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            ...
            cell = new PdfPCell(new Phrase("SITE", H));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 3;
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            ...
            cell = new PdfPCell(new Phrase("CONTACT EMAILID", H));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.Colspan = 3;
            cell.PaddingBottom = 5;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
